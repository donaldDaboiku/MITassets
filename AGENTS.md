...
- Presence: only auto-toggle `active` ↔ `offline`; never override available/maintenance/retired/lost. Heartbeat writes go through the Edge Function + `HEARTBEAT_SECRET`, not the anon key.
